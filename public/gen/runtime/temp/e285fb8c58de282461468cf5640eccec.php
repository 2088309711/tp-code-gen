                  ...
                  <div class="form-horizontal">
                    <form id="form1" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">                               
                               <input name="projectName" class="form-control" value="<?php echo get_db_config('app_namespace'); ?>" type="text">
                            </div>
                            <span class="col-lg-4"></span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">                               
                               <input name="projectPath" class="form-control" value="<?php echo get_db_config('projectPath'); ?>" type="text">
                            </div>
                            <span class="col-lg-4"></span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">                               
                               <input name="projectPublicPath" class="form-control" value="<?php echo get_db_config('projectPublicPath'); ?>" type="text">
                            </div>
                            <span class="col-lg-4"></span>
                        </div>
