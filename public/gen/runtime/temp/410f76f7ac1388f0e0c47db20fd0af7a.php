<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"template/WedgitCode\menu.html";i:1546506062;s:67:"F:\phpStudy\WWW\tp-code-gen\public\gen\template\default_layout.html";i:1546420313;s:61:"F:\phpStudy\WWW\tp-code-gen\public\gen\template\leftmenu.html";i:1546420488;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
    ...
    function gogogo(moduleName, selectTableName, layoutName, codelibName, menuName, saveFile) {
        $.post("<?php echo url(CONTROLLER_NAME.'/creatFiles'); ?>", {
                'moduleName': moduleName, 'selectTableName': selectTableName,
                                ...
                                <div class="form quick-post">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="layoutName" value="<?php echo $layoutName; ?>" disabled="disabled"
                                                       class="form-control" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input id="codelibName" value="<?php echo $codelibName; ?>" disabled="disabled"
                                                       class="form-control" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <p>
                                                    <input class="form-control" name="saveFileName" id="saveFileName"
                                                           type="text" value="menu1" placeholder="（不加后缀）">
                                                </p>
                                                <p>
