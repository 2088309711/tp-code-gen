<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"F:\phpStudy\WWW\tp-code-gen\public\gen\codeRepository\amaze\View\edit.html";i:1551258625;}*/ ?>
{extend name="layout" /}
{block name="content"}
<!-- 内容区域 -->
<div class="tpl-content-wrapper">
    ...
    <div class="am-form-group">
        <label for="<?php echo $tableInfo[$columnNameKey]; ?>" class="am-u-sm-12 am-form-label am-text-left"><?php echo pressFieldDict($tableName,
