...
class ModelCode extends Base
{
    ...
    {
        $moduleName = I('moduleName');
        $modelPath = BASE_PATH . get_db_config('projectPath') . $moduleName . DS . 'controller' . DS;
        $tableName = getTableName(I('tableName'));
    ...
    {
        $moduleName = I('moduleName');
        $modelPath = BASE_PATH . get_db_config('projectPath') . $moduleName . DS . 'file_out' . DS . 'model' . DS;
        $tableName = getTableName(I('tableName'));
        if (!file_exists($modelPath)) {
            FileUtil::createDir($modelPath);
        }
