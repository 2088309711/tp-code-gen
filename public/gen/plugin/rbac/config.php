...
return [
    ...
    'copyFiles' => [ //复制的文件列表及其规则  '文件名'=>'复制路径'
        'files/tags.php' => BASE_PATH . get_db_config('projectPath'),
        'files/behavior' => BASE_PATH . get_db_config('projectPath'),
        'files/extra/rbac.php' => '../' . BASE_PATH . get_db_config('projectPath'),
    ],
];