...
class Enewsjstemp extends Validate{
...
protected $scene =   [
    'add'=>['tempid','tempname','temptext','classid','isdefault','showdate','modid','subnews','subtitle',],
    'edit'=>['tempid','tempname','temptext','classid','isdefault','showdate','modid','subnews','subtitle',],
    'ck_id'=>['id']
];
