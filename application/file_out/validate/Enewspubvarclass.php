...
class Enewspubvarclass extends Validate{
...
protected $rule =   [
        ...
        'classsay' => 'require|number|float|boolean|email|array|accepted|date|alpha|alphaNum|alphaDash|chs|chsAlpha|chsAlphaNum|chsDash|activeUrl|url|ip|length:4,25|max:25|min:5',
    ];
...
'classsay.require' => 'classsay不能为空',
'classsay.number' => 'classsay不是数字',
'classsay.float' => 'classsay不是小数',
'classsay.boolean' => 'classsay不是布尔值',
'classsay.email' => 'classsay不是邮箱地址',
'classsay.array' => 'classsay不是数组',
'classsay.accepted' => 'classsay请确认',
'classsay.date' => 'classsay不是有效日期',
'classsay.alpha' => 'classsay不是字母',
'classsay.alphaNum' => 'classsay不是字母和数字',
'classsay.alphaDash' => 'classsay不是字母和数字和下划线及破折号',
'classsay.chs' => 'classsay只能是汉字',
'classsay.chsAlpha' => 'classsay只能是汉字、字母',
'classsay.chsAlphaNum' => 'classsay只能是汉字、字母和数字',
'classsay.chsDash' => 'classsay只能是汉字、字母、数字和下划线_及破折号-',
'classsay.activeUrl' => 'classsay不是有效的域名或者IP',
'classsay.url' => 'classsay不是有效的URL地址',
'classsay.ip' => 'classsay不是有效的IP地址',
'classsay.length' => 'classsay长度不符',
'classsay.max' => 'classsay超出最大长度',
'classsay.min' => 'classsay低于最小长度',
];

protected $scene =   [
    'add'=>['classid','classname','classsay',],
    'edit'=>['classid','classname','classsay',],
    'ck_id'=>['id']
];
