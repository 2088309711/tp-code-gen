...
class EcmsDownloadCheckData extends Validate{
...
protected $scene =   [
    'add'=>['id','classid','keyid','dokey','newstempid','closepl','haveaddfen','infotags','softwriter','homepage','demo','downpath',],
    'edit'=>['id','classid','keyid','dokey','newstempid','closepl','haveaddfen','infotags','softwriter','homepage','demo','downpath',],
    'ck_id'=>['id']
];
