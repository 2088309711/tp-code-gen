...
class Enewsnewstemp extends Validate{
...
protected $scene =   [
    'add'=>['tempid','tempname','isdefault','temptext','showdate','modid','classid',],
    'edit'=>['tempid','tempname','isdefault','temptext','showdate','modid','classid',],
    'ck_id'=>['id']
];
