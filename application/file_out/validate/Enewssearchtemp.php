...
class Enewssearchtemp extends Validate{
...
protected $scene =   [
    'add'=>['tempid','tempname','temptext','subnews','isdefault','listvar','rownum','modid','showdate','subtitle','classid','docode',],
    'edit'=>['tempid','tempname','temptext','subnews','isdefault','listvar','rownum','modid','showdate','subtitle','classid','docode',],
    'ck_id'=>['id']
];
