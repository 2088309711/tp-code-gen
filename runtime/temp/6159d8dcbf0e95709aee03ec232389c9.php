<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"F:\phpStudy\WWW\tp-code-gen\public/../application/index\view\corpus_data\lists.html";i:1551258466;s:62:"F:\phpStudy\WWW\tp-code-gen\application\index\view\layout.html";i:1551258459;s:61:"F:\phpStudy\WWW\tp-code-gen\application\index\view\menu1.html";i:1551258462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="tpl-content-wrapper">
            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    <div class="widget-head am-cf">
                        <div class="widget-title  am-cf">管理corpus_data</div>
                    </div>
		...
		<div class="am-form-group">
			<div class="am-btn-toolbar">
				<div class="am-btn-group am-btn-group-xs">
					<a class="am-btn am-btn-default am-btn-success" href="<?php echo url('corpus_data/add'); ?>">
	...
	<div class="am-u-sm-12">
		<table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black " id="example-r">
				...
				<tbody>
						<?php if(is_array($corpus_dataList) || $corpus_dataList instanceof \think\Collection || $corpus_dataList instanceof \think\Paginator): $i = 0; $__LIST__ = $corpus_dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<tr class="gradeX">
										...
										<div class="tpl-table-black-operation">
												<a  href="<?php echo url('corpus_data/edit', ['id'=>$vo['id']]); ?>">
													<i class="am-icon-pencil"></i> 编辑
												</a>
												<a href="<?php echo url('corpus_data/delete', ['id'=>$vo['id']]); ?>" onclick='return confirm("确定删除吗？")' class="tpl-table-black-operation-del">
	...
	<div class="am-u-lg-12 am-cf">
			...
			<div class="am-fr">
					<ul class="am-pagination tpl-pagination">
							<?php echo $corpus_dataList->render(); ?>
					</ul>
			</div>
	</div>
</div>
